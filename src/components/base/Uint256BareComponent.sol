...
contract Uint256BareComponent is BareComponent {
	...
	function setBatch(uint256[] memory entities, uint256[] memory values) external virtual onlyWriter {
	...
	function extractBatch(uint256[] memory entities) external virtual onlyWriter returns (uint256[] memory) {
